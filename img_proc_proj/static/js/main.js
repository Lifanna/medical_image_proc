    ...
    $("#addNewImgBtn").click(() => {
        ...
        $("#prependDiv").append(`
            <div id="photoDiv` + imagesCount + `" class="col-6 mt-2">
                ...
                <div class="card shadow-lg rounded">
                    <div class="card-body text-center">
                        <textarea class="form-control" placeholder="You can add summary about Your medical image here" id="exampleFormControlTextarea1" rows="3"></textarea>
                    </div>
                </div>
                <div class="card shadow-lg rounded">
                    <div class="card-body text-center">
                        <input type="button" class="btn btn-primary" value="Analyse" id="uploadBtn` + imagesCount + `">
                            ...
                            <div class="col-6 mt-4" id="detectedPhotoDiv` + id + `">
                                <div class="card shadow-lg rounded">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-12">
                                                <label class="text-primary" id="RESULT"><b class="text-secondary">Result:</b> ` + response.result + `</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
